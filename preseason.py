...
class PreSeasonExtractor:
    ...
    def _process_single_lap(
        ...
        try:
            ...
            data_key = (
                f"{self.year}-PreSeasonTest-Practice {session_number}-{driver}-{lap_number}"
            )
    ...
    def process_testing_session(
        ...
        base_dir = (
            f"Pre-Season Test/Practice {session_number}"
        )
    ...
    def process_all(self) -> None:
        ...
        logger.info(
            f"Pre-season test extraction completed in {elapsed:.2f} seconds"
        )
